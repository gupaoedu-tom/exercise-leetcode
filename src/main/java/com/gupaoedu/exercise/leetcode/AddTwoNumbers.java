...
public class AddTwoNumbers {
    ...
    class IterationSolution implements Solution{
        ...
        public ListNode addTwoNumbers(ListNode l1, ListNode l2) {
            ...
            while (l1 != null && l2 != null){
                tempVal = l1.val + l2.val + nextCarry;
                curr.next = new ListNode(tempVal % 10);
                nextCarry = tempVal /10;
                l1 = l1.next;
                l2 = l2.next;
                curr = curr.next;
            }
    ...
    class RecursionSolution implements Solution{
        public ListNode addTwoNumbers(ListNode l1, ListNode l2) {
            ...
            int nextCarry = tempVal / 10;
            ListNode result = new ListNode(tempVal % 10);
